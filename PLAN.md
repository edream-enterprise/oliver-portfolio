...
- Seleccionar _Skeleton project_.
...
- Importar las fuentes _JetBrains Mono_ e _Inter_ en `app.html` o vía `@font-face` en un archivo CSS global.
...
Migrar los scripts _vanilla_ de la parte inferior del HTML a la reactividad de Svelte.
...
- Asegurar que no haya errores de accesibilidad (a11y), SvelteKit es estricto con esto (ej. inputs sin _labels_ asociadas de forma correcta).
